CREATE OR REPLACE VIEW `delivery_zone.vw_ordem_modificacao` (
    ...
    TP_Ordem           OPTIONS(description="Valor padrão 'MODIFICAÇÃO'"),
    TS_Inicio_Ordem    OPTIONS(description="Data e hora de início do processo de modificação. Ex: 2009-12-01 13:02:01 UTC"),
    TS_Fim_Ordem       OPTIONS(description="Data e hora de início do fim do processo de modificação. Ex: 2009-12-01 13:02:01 UTC"),
    TS_Ult_Atualizacao OPTIONS(description="Data e hora da última atualização do processo de modificação. Ex: 2009-12-01 13:02:01 UTC"),
    DT_FOTO            OPTIONS(description="Data de foto da ordem.")
)
OPTIONS(
    description="Uma visão que representa as ordens do tipo MODIFICAÇÃO. \nDomínio de Dado: Eficiência Operacional - eop \nPeríodo de retenção: a definir \nClassificação da Informação: a definir",
