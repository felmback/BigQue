CREATE OR REPLACE VIEW `delivery_zone.vw_ordem_reconfiguracao` (
    ID_Access          OPTIONS(description="Código identificador único do cliente. PMJ-57017871-069"),
    ...
    TP_Ordem           OPTIONS(description="Valor padrão 'RECONFIGURAÇÃO'"),
    TS_Inicio_Ordem    OPTIONS(description="Data e hora de início do processo de reconfiguração. Ex: 2009-12-01 13:02:01 UTC"),
    TS_Fim_Ordem       OPTIONS(description="Data e hora de início do fim do processo de reconfiguração. Ex: 2009-12-01 13:02:01 UTC"),
    TS_Ult_Atualizacao OPTIONS(description="Data e hora da última atualização do processo de reconfiguração. Ex: 2009-12-01 13:02:01 UTC"),
    DT_FOTO            OPTIONS(description="Data de foto da ordem.")
)
OPTIONS(
    description="Uma visão que representa as ordens do tipo RECONFIGURAÇÃO. \nDomínio de Dado: Eficiência Operacional - eop \nPeríodo de retenção: a definir \nClassificação da Informação: a definir",
