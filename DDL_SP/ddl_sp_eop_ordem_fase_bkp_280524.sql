-- CREATE TABLE IF NOT EXISTS `gold_zone.tb_eop_ordem_fase` 
-- (
-- ID_Access STRING OPTIONS(description="Identificador do cliente"),
-- ID_Reserva STRING OPTIONS(description="Identificador da Reserva - reserveId"),
-- ID_Correlation STRING OPTIONS(description="Identificador da Correlação"),
-- ID_Endereco INT64 OPTIONS(description="dentificador do Endereço da Reserva - ID_ADDRESS"),
-- ID_Endereco_Base INT64 OPTIONS(description="Identificador do Endereço Base da Reserva - ID_BASE_ADDRESS"),
-- ID_Localidade INT64 OPTIONS(description="Identicador da Localidade do Endereço da Reserva - ID_LOCATION"),
-- IN_Estado_Ordem STRING OPTIONS(description="Indicador do Estado da Ordem, Ex: Completed, Failed, Cancelled"),
-- IN_TENANT STRING OPTIONS(description="Cliente"),
-- TP_Ordem STRING OPTIONS(description="Tipo da ordem, Ex.: Aprovisionamento, Desconexão, Emparelhamento, Ativação, Change, Rollback"),
-- Ordem_Origem STRING OPTIONS(description="Canal de entrada da ordem API/POTAL"),
-- TS_Inicio_Ordem TIMESTAMP OPTIONS(description="Data e Hora do Início da Ordem"),
-- TS_Fim_Ordem TIMESTAMP OPTIONS(description="Data e Hora da Conclusão da Ordem"),
-- TS_Ult_Atualizacao TIMESTAMP OPTIONS(description="Data e Hora da Última Atualização da Ordem"),
-- DT_FOTO DATETIME OPTIONS(description="Data da Foto da Ordem"),
--     )
...
CREATE OR REPLACE PROCEDURE `fibrasil-datalake-dev.gold_zone.sp_eop_ordem_fase`()
